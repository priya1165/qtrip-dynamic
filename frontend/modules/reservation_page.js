...
let tableBody = document.getElementById("reservation-table")
  ...
  reservations.forEach((reservation) => {
    ...
    let convertedDate = dateObj.toLocaleDateString("en-IN")

    let timeObj = new Date(reservation.time)
    let convertedTimeString = timeObj.toLocaleTimeString("en-IN", {
      day: "numeric",
      month: "long",
      year: "numeric",
      hour: "numeric",
    ...
    let finalTime = convertedTimeString.replace(" at", ",")
